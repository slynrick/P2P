...
class Message extends React.Component {
  ...
  likeMessage(block) {
    // fetch('/freechains/chain/like/%23' + this.props.chain + "/" + block, {
    //   headers: {
    //     'Accept': 'application/json',
    //     'Content-Type': 'application/json'
    //   },
    //   method: "GET",
    //   body: JSON.stringify({shared: this.props.pubkey})
  ...
  dislikeMessage(block) {
    // fetch('/freechains/chain/dislike/%23' + this.props.chain + "/" + block, {
    //   headers: {
    //     'Accept': 'application/json',
    //     'Content-Type': 'application/json'
    //   },
    ...
    return (
      <div className="Message">
        <ListItem key={this.props.blockHash} alignItems="flex-start">
            ...
            <IconButton onClick={this.likeMessage(this.props.block)}>
            ...
            <IconButton onClick={this.dislikeMessage(this.props.block)} >
                <Badge badgeContent={1200} color="primary" max={9999}
                anchorOrigin={{
                    vertical: 'top',
                    horizontal: 'right',
